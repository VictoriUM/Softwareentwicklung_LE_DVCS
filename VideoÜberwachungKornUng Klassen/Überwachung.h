...
private:
	bool checkBoundingrectInNoCamArea(Vector<Point> noCamArray, Point pt1, Point pt2);	//Prüft, ob sich das Boundingrect im nicht überwachten Bereich befindet
	...
	int alarmgrösse;															//Int Variable für die Größe eines Objektes(in Pixeln), ab welcher der Alarm ausgelöst wird
};
#endif